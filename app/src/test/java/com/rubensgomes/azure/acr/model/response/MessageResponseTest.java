package com.rubensgomes.azure.acr.model.response;
...
class MessageResponseTest {
  ...
  class BeanValidation {
    ...
    static void buildValidator() {
      // A ParameterMessageInterpolator is used instead of the default one so
      // that this test does not require a Jakarta EL implementation on the test
      // classpath.
      factory =
