/*
 * azure-acr Gradle build script (Kotlin DSL)
 *
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            // Gradle project directory ("app") instead of "azure-acr".
...
spotless {
    ...
    java {
        ...
        //
        // formatJavadoc is off because the formatter's column limit is
        // hard-coded to 100 and is not configurable. Leaving Javadoc alone is
        // what lets comments and Javadoc keep the 80-column limit declared in
        // ".editorconfig"; a reflow on every build would otherwise widen them
        // back to 100. Code still wraps at 100.
