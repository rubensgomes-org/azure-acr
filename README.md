...
complete and green; the Azure Container Registry integration itself is not wired up yet — see
...
```bash
git clone https://github.com/rubensgomes-org/azure-acr.git
cd azure-acr
```
...
└── app/
    ...
    └── src/
        ...
        ├── main/java/com/rubensgomes/azure/acr/
